...
namespace AppcontableCompueasys2._2.Controllers
{
    ...
    public class MarcasController : Controller
    {
        ...
        public MarcasController(DbcontableContext context)
        {
            _context = context;
        }
        ...
        public ActionResult Get()
        {
            ...
            var marcas = _context.Marcas.Where(m => m.IdEmpresa == empresa.Id);
            return StatusCode(StatusCodes.Status200OK, marcas);
        }
